...
function buildVariant(seed) {
    const inventory = seed.stock > 0 || seed.reserved
        ? {
            stock: seed.stock,
...
const productSeeds = [
    {
        ...
        description: "Sauvage Eau de Toilette captures raw freshness with vibrant bergamot and a powerful trail of Ambroxan.",
    ...
    },
    {
        ...
        description: "Sauvage Eau de Parfum deepens the signature freshness with warm vanilla and sensual woods.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Sauvage Parfum is a refined take with dense woods and smooth tonka, amplifying the iconic trail.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Sauvage Elixir pushes the blend to powerful heights with rich spices and deep woods.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Bleu De Chanel EDT blends sparkling citrus with aromatic woods for an all-occasion signature.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Bleu De Chanel EDP warms the original freshness with velvety amber woods for evening sophistication.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Bleu De Chanel Parfum is a creamy, full-bodied interpretation with smooth sandalwood and tonka bean.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Bleu De Chanel L'Exclusif is a boutique edition with heightened woods and smoky incense nuances.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
    ...
    },
    {
        ...
        description: "Miss Dior is a blooming bouquet of Grasse rose, luminous peony, and whispering musk that wraps the wearer like couture.",
        createdAt: commonTimestamp,
        updatedAt: commonTimestamp,
        media: [
            {
...
const products = productSeeds.map((seed) => {
    ...
    return {
        ...
        aggregates: {
            ...
            lowPricePaise,
            inStockVariants: activeVariants.filter((variant) => (variant.inventory?.stock ?? 0) > 0).length,
        },
    };
});
...
function getDefaultVariant(slug) {
    const product = products.find((item) => item.slug === slug);
    if (!product) {
        return undefined;
    }
